...
//       alert('لا يمكن إنهاء الوردية. يوجد طلبات غير مؤكدة.');
//       return;
//     }

//     if (window.confirm('هل أنت متأكد من إنهاء الوردية؟ سيتم تسجيل خروجك من النظام.')) {
//       // Call API to deactivate distributor account
//       const userId = localStorage.getItem('userId');
//       if (userId) {
//         axiosInstance.post(`/distributors/${userId}/deactivate`)
//           .then(() => {
//             navigate('/login');
//           })
//           .catch((error) => {
//             console.error('Error deactivating account:', error);
//             alert('حدث خطأ أثناء إنهاء الوردية. حاول مرة أخرى.');
//           });
//       }
//       navigate('/login');
//     }
...
//       cost: '',
//       statusString: 'New',
//       distributorId: localStorage.getItem('userId') // Add distributor ID
//     };
...
//         const customer = distributorCustomersStore.customers.find(c => c.name === order.customerId);
//         if (customer) {
...
//               }]
//             };
//             distributorCustomersStore.updateCustomer(updatedCustomer);
//           }
//         }
//       }
//     }
...
//           getCustomer={(name) => distributorCustomersStore.customers.find(c => c.name === name)}
//         />
